...
const models = {
  ...
  bebidas: [
    ...
    { path: `${baseURL}/bebidas/caneca.glb`, price: 18.00, info: `${baseURL}/informacoes/caneca.txt` },
    ...
    { path: `${baseURL}/bebidas/chocolate_quente.glb`, price: 10.00, info: `${baseURL}/informacoes/chocolate_quente.txt` },
    { path: `${baseURL}/bebidas/fizzy_drink.glb`, price: 8.00, info: `${baseURL}/informacoes/fizzy_drink.txt` },
