...
const models = {
  ...
  pizzas: [
    ...
    { path: `${modelBaseURL}/pizzas/pepperoni.glb`,             price: 45.00, info: `${modelBaseURL}/informacao/${nomeRestaurante}/pepperoni.json` },
    { path: `${modelBaseURL}/pizzas/vegetariana.glb`,           price: 45.00, info: `${modelBaseURL}/informacao/${nomeRestaurante}/vegetariana.json` },
    { path: `${modelBaseURL}/pizzas/brocolis.glb`,              price: 45.00, info: `${modelBaseURL}/informacao/${nomeRestaurante}/brocolis.json` },
    { path: `${modelBaseURL}/pizzas/champignon.glb`,            price: 45.00, info: `${modelBaseURL}/informacao/${nomeRestaurante}/champignon.json` },
